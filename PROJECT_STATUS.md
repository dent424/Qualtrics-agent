...
- ✅ `reference/playwright-api.md` - Browser automation quick reference
- ✅ `reference/qualtrics-selectors.md` - DOM structure and question types
...
### Slash Commands
- ✅ `.claude/commands/take-survey.md` - Main automation command
...
4. ⏳ Writes Playwright automation code on-the-fly
5. ⏳ Executes the automation
...
- Watches Claude Code navigate survey
...
**Runtime:**
- playwright: ^1.49.1 (only dependency)
- Node.js: >=18.0.0
...
**Lines of code:**
- TypeScript: ~500 lines (personas + behavioral timing)
- Documentation: ~3000 lines (reference guides)
- Commands: ~400 lines (instructions for Claude Code)
...
2. "Behavioral differences in action" (speed, thoroughness)
3. "How it handles errors" (bot detection, unknown questions)
4. "Behind the scenes" (persona system, timing calculations)
5. "Easy setup" (clone + npm install)
